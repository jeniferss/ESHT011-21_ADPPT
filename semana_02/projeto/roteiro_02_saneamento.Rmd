...
Na Análise Exploratória de Dados (EDA), são utilizados métodos para resumir, visualizar e interpretar as principais características dos dados antes de realizar modelagens ou análises complexas.
